...
internal class ESPMContainerMetadataChanges: ObjectBase {
    ...
    private class func merge1(metadata: CSDLDocument) {
        ...
        if !ESPMContainerMetadata.ActionImports.generateSamplePurcharOrders.isRemoved {
            ESPMContainerMetadata.ActionImports.generateSamplePurcharOrders = metadata.dataMethod(withName: "GenerateSamplePurcharOrders")
        }
